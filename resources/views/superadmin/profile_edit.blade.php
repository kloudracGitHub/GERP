 ...
 -->
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fname" id="fname" value="{{ $userprofile->first_name }}" maxlength="60" class="form-control project_box">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mname" id="mname" value="{{ $userprofile->middle_name }}"  maxlength="60" class="form-control project_box">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="lname" id="lname" value="{{ $userprofile->last_name }}" maxlength="60" class="form-control project_box">
                                     ...
                                     <!--    <div class="col-xs-12 col-sm-6">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="emailaddress" id="emailaddress" value="{{ $userprofile->email }}" maxlength="60" class="form-control project_box">
                                    <div id="emailaddress_error"></div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="alt_emailaddress" id="alt_emailaddress" value="{{ $userprofile->alt_email }}" maxlength="60" class="form-control project_box">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="role" id="role"  class="form-control project_box">
                                                    ...
                                                    <option value="admin"  @if($userprofile->role == 'admin')  selected  @endif >Admin</option>

                                                    <option value="project_Manager" @if($userprofile->role == 'project_Manager')  selected  @endif>Project Manager</option>

                                                    <option value="employee" @if($userprofile->role == 'employee')  selected  @endif>User</option>
...
<div class="row">
    ...
    <div class="col-sm-8">
                                                        <input type="text" onkeypress="preventNonNumericalInput(event)" name="mobile" id="mobile" value="{{ $userprofile->mobile_no }}" maxlength="10" class="form-control project_box">
    </div>
</div>
...
<div class="row">
    <div class="col-sm-4">
       <input type="text" class="form-control project_box" value="{{ $userprofile->pre_alt_mob }}" name="pre_alt_mob"  maxlength="5">
    </div>
    <div class="col-sm-8">
                                                <input type="text" onkeypress="preventNonNumericalInput(event)" name="alternate" id="alternate"  value="{{ $userprofile->alternate_no }}" maxlength="10" class="form-control project_box">
    </div>
</div>
                                         ...
                                         <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="pancard" id="pancard"  value="{{ $userprofile->pancard_no }}" maxlength="10" class="form-control project_box">
                                    <div id="pancard_error"></div>
                                         ...
                                         <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" onkeypress="preventNonNumericalInput(event)" name="adhaar" id="adhaar"  value="{{ $userprofile->adhaar_card }}" maxlength="12" class="form-control project_box">
                                         ...
                                         <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="designation" id="designation" value="{{ $userprofile->desgination }}" maxlength="60" class="form-control project_box">
                                         ...
                                         <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="dob" name="dob" value="{{ $userprofile->dob }}" placeholder="dd/mm/yyyy" class="dateTxt form-control project_box">
                                         ...
                                         <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" id="address" value="{{ $userprofile->address }}" maxlength="200"  class="form-control project_box">
  ...
  <div id="empstate_error"></div>
                                    ...
                                    <div id="city_error"></div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="landmark" id="landmark" value="{{ $userprofile->landmark }}" maxlength="200" class="form-control project_box">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" onkeypress="preventNonNumericalInput(event)" name="pincode" id="pincode" value="{{ $userprofile->pincode }}" maxlength="6" class="form-control project_box">
                                    ...
                                    <img id="blah" src="{{URL::to('/uploads_profileimg/'.$userprofile->photo)}}" alt="user" class="rounded-circle" width="67px">
                                    @else
                                       <img id="blah" src="{{URL::to('assets/download.png')}}" alt="user" class="rounded-circle" width="67px">
                                    @endif
